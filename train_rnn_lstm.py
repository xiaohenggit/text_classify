...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--data-path", default=r".\aclImdb", type=str,
                        help="dataset path")
    parser.add_argument("--glove-file-path", default=".\glove.6B\glove.6B.100d.txt", type=str,
                        help="预训练词向量文件")
...
if __name__ == "__main__":
    ...
    # ------------------------------------ step1: dataset ------------------------------------
    vocab_path = os.path.join(BASE_DIR, 'result', "aclImdb_vocab.npy")  # 通过 gen_vocabulary.py 获得
